 ...
 */
public class AccessControlPartTreeJpaQuery extends AbstractJpaQuery {
	...
	/**
	 * Creates a new {@link AccessControlPartTreeJpaQuery}.
	 * 
	 * @param method must not be {@literal null}.
	 * @param em must not be {@literal null}.
	 */
	public AccessControlPartTreeJpaQuery(JpaQueryMethod method, EntityManager em) {
	...
	private class QueryPreparer {
		...
		protected JpaQueryCreator createCreator(ParametersParameterAccessor accessor) {
			...
			return new AccessControlQueryCreator(tree, domainClass, builder, provider);
		}
	...
	private class CountQueryPreparer extends QueryPreparer {
		 ...
		 * 
		 * @see org.springframework.data.jpa.repository.query.AccessControlPartTreeJpaQuery.QueryPreparer#invokeBinding(org.springframework.data.jpa.repository.query.ParameterBinder,
